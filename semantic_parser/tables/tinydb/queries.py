...
class Query(object):
    ...
    def include(self, rhs):
        return self._generate_test(lambda value: rhs in value, 
                                   ('include', tuple(self._path), rhs))

    def count_eq(self, rhs):
        return self._generate_test(lambda value: len(value) == rhs,
                                   ('count_eq', tuple(self._path), rhs))
  

    def count_ne(self, rhs):
        return self._generate_test(lambda value: len(value) != rhs,
                                   ('count_nq', tuple(self._path), rhs))


    def count_ge(self, rhs):
        return self._generate_test(lambda value: len(value) >= rhs,
                                   ('count_ge', tuple(self._path), rhs))


    def count_le(self, rhs):
        return self._generate_test(lambda value: len(value) <= rhs,
                                   ('count_le', tuple(self._path), rhs))

    def count_gt(self, rhs):
        return self._generate_test(lambda value: len(value) > rhs,
                                   ('count_gt', tuple(self._path), rhs))

    def count_lt(self, rhs):
        return self._generate_test(lambda value: len(value) < rhs,
                                   ('count_lt', tuple(self._path), rhs))
